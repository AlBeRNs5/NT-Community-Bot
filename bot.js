...
client.user.setGame(`NT Community - *help `,"https://www.twitch.tv/dggamingbot")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
const config = { prefix: "*", token: "NTM5NTc1NTY2NjYwMTQxMTA2.DzEYAg.baRndTCocaluuhvDFSZ55grQTzk" };
const tpoints = {};
const vpoints = {};
hero.config = config;
...
var shopc = message.guild.channels.find("name","nt-store")
